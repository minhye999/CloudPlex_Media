...
class Assets_Create_Mp3(unittest.TestCase):
    ...
    def test_check_type_local(self):  # Type : MP3 > Local File 확인
        driver = self.driver
        ...
        try:
            ...
            time.sleep(3)
            # Type 선택 (MP3)
            driver.find_element_by_id("rdb-asset-type-MP3").click()
            time.sleep(3)
            # [Select a file]버튼 클릭
            driver.find_element_by_xpath(
    ...
    def test_check_type_s3(self):  # Type : MP3 > S3 File 확인
        ...
        try:
            ...
            # 유효한 경로 입력 (https://mz-cm-stg-transcoding-input.s3.ap-northeast-2.amazonaws.com/testdata/test_002_Chinese.mp3)
