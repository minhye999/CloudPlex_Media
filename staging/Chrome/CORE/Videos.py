...
def suite():
    ...
    suite.addTest((Videos("test_check_advancedSearch_jobId")))
    suite.addTest((Videos("test_check_advancedSearch_owner")))
    suite.addTest((Videos("test_check_advancedSearch_status")))
    suite.addTest((Videos("test_check_advancedSearch_mediaType")))
    suite.addTest((Videos("test_check_advancedSearch_ingestType")))
    suite.addTest((Videos("test_check_advancedSearch_type")))
    ...
    #suite.addTest((Videos("test_check_attributions")))
    #suite.addTest((Videos("test_check_tags")))
    return suite
