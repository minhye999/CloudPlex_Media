...
class Streams_Create_RTP(unittest.TestCase):
    ...
    def test_check_input_whitelist(self):  # whitelist 입력하여 RTP생성
        driver = self.driver
        ...
        try:
            ...
            time.sleep(3)
            # Type 선택 (RTP(PUSH))
            driver.find_element_by_xpath("(//input[@name='streamTypes'])[2]").click()
            time.sleep(10)
            ...
            driver.find_element_by_xpath(
                ...
                "0.0.0.0/0")
            time.sleep(3)
            # 그 외 필수값(Name_rtp1) 입력하고 [Create]버튼 클릭
            driver.find_element_by_xpath("//input[@value='']").click()
            driver.find_element_by_xpath("//input[@value='']").clear()
            driver.find_element_by_xpath("//input[@value='']").send_keys("rtp1")
            time.sleep(5)
            driver.find_element_by_xpath(
                "(.//*[normalize-space(text()) and normalize-space(.)='Cancel'])[1]/following::button[1]").click()
            time.sleep(5)
            # 생성한 Stream상세 페이지의 타이틀 확인 (rtp1)
            self.assertEqual("rtp1", driver.find_element_by_xpath(
    ...
    def test_check_anywhere_whitelist(self):  # anywhere 클릭하여 생성
        ...
        try:
            ...
            # 그 외 필수값(Name_rtp2) 입력하고 [Create]버튼 클릭
            driver.find_element_by_xpath("//input[@value='']").click()
            driver.find_element_by_xpath("//input[@value='']").clear()
            driver.find_element_by_xpath("//input[@value='']").send_keys("rtp2")
            time.sleep(5)
            driver.find_element_by_xpath(
                "(.//*[normalize-space(text()) and normalize-space(.)='Cancel'])[1]/following::button[1]").click()
            time.sleep(5)
            # 생성한 Stream상세 페이지의 타이틀 확인 (rtp2)
            self.assertEqual("rtp2", driver.find_element_by_xpath(
                "(.//*[normalize-space(text()) and normalize-space(.)='Channels'])[1]/following::span[1]").text)
            time.sleep(5)
    ...
    def test_check_select_whitelist(self):  # whitelist 리스트 선택하여 생성
        ...
        try:
            ...
            driver.find_element_by_xpath(
             "(.//*[normalize-space(text()) and normalize-space(.)='Cancel'])[1]/following::button[1]").click()
            time.sleep(3)
            # 그 외 필수값(Name_rtp3) 입력하고 [Create]버튼 클릭
            driver.find_element_by_xpath("//input[@value='']").click()
            driver.find_element_by_xpath("//input[@value='']").clear()
            driver.find_element_by_xpath("//input[@value='']").send_keys("rtp3")
            time.sleep(5)
            driver.find_element_by_xpath(
                "(.//*[normalize-space(text()) and normalize-space(.)='Cancel'])[1]/following::button[1]").click()
            time.sleep(5)
            # 생성한 Stream상세 페이지의 타이틀 확인 (rtp3)
            self.assertEqual("rtp3", driver.find_element_by_xpath(
                "(.//*[normalize-space(text()) and normalize-space(.)='Channels'])[1]/following::span[1]").text)
            time.sleep(5)
...
def suite():
    ...
    suite.addTest(Streams_Create_RTP('test_check_input_whitelist'))
    suite.addTest(Streams_Create_RTP("test_check_anywhere_whitelist"))
    suite.addTest(Streams_Create_RTP("test_check_select_whitelist"))
    return suite
